...
export default function ImageComparison({ selectedRegion }: ImageComparisonProps) {
  ...
  const getRegionImages = (region: string) => {
    ...
    if (region === "Lake Śniardwy") {
      return {
        current: "/placeholder.svg?height=300&width=600&text=Lake+Śniardwy+2025",
        future: "/placeholder.svg?height=300&width=600&text=Lake+Śniardwy+2035+Prediction",
      }
    } else if (region === "Lake Mamry") {
      return {
        current: "/placeholder.svg?height=300&width=600&text=Lake+Mamry+2025",
        future: "/placeholder.svg?height=300&width=600&text=Lake+Mamry+2035+Prediction",
      }
    } else if (region === "Lake Niegocin") {
      return {
        current: "/placeholder.svg?height=300&width=600&text=Lake+Niegocin+2025",
        future: "/placeholder.svg?height=300&width=600&text=Lake+Niegocin+2035+Prediction",
      }
    } else {
      return {
        current: "/placeholder.svg?height=300&width=600&text=Masuria+Region+2025",
        future: "/placeholder.svg?height=300&width=600&text=Masuria+Region+2035+Prediction",
      }
    }
  }
