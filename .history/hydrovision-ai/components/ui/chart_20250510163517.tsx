...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <RechartsPrimitive.ResponsiveContainer width="100%" height="100%" className={className} {...props}>
      {children}
    </RechartsPrimitive.ResponsiveContainer>
  )
})
...
// Add a simpler ChartContainer definition that accepts title and description props
const SimpleChartContainer = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div"> & {
    title: string
    description: string
...
SimpleChartContainer.displayName = "ChartContainer"

// Update export section 
export {
  SimpleChartContainer as ChartContainer,
  Chart,
  ChartTooltip,
  ChartTooltipContent,
  ChartLegend,
